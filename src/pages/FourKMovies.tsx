...
const FourKMovies = () => {
  ...
  const { movies, loading, error } = useMovies("4k");
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h1 className="text-3xl md:text-4xl font-bold text-foreground">4K Movies</h1>
                  <Sparkles className="w-8 h-8 text-primary" />
                </div>
                <p className="text-muted-foreground">Experience cinema in stunning 4K Ultra HD quality</p>
              </div>
            </div>
          ...
          <div className="backdrop-blur-xl bg-card/60 border border-luxury-border rounded-2xl p-4 md:p-8 shadow-2xl">
            {loading ? (
              <div className="text-center py-8 md:py-12">
                <p className="text-muted-foreground text-base md:text-lg">Loading 4K movies...</p>
              </div>
            ) : error ? (
              <div className="text-center py-8 md:py-12">
            ...
            {!loading && !error && filteredMovies.length === 0 && searchQuery && (
              <div className="text-center py-8 md:py-12">
                <p className="text-muted-foreground text-base md:text-lg">No 4K movies found for "{searchQuery}"</p>
            ...
            {!loading && !error && movies.length === 0 && !searchQuery && (
              <div className="text-center py-8 md:py-12">
                <p className="text-muted-foreground text-base md:text-lg">No 4K movies available</p>
      ...
      <section className="relative z-10 px-4 md:px-6 pb-12">
        <div className="max-w-7xl mx-auto text-center">
          <div className="backdrop-blur-xl bg-card/40 border border-luxury-border rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-muted-foreground mb-6">Join our Telegram group for instant notifications on new 4K movies</p>
            <TelegramJoin 
              variant="default" 
