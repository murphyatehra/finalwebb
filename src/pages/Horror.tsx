...
import { Search, Filter, Skull, ArrowLeft } from "lucide-react";
...
const Horror = () => {
  ...
  const { movies, loading, error } = useMovies("horror");
        ...
        <div className="max-w-7xl mx-auto">
          <div className="backdrop-blur-xl bg-card/80 border border-luxury-border rounded-2xl p-6 md:p-8 shadow-2xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h1 className="text-3xl md:text-4xl font-bold text-foreground">Horror Movies</h1>
                  <Skull className="w-8 h-8 text-red-500" />
                </div>
                <p className="text-muted-foreground">Get ready for spine-chilling thrills and terrifying adventures</p>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <Button className="bg-red-600 hover:bg-red-700 text-white px-6 md:px-8 py-2 md:py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-sm md:text-base">
          ...
          <div className="backdrop-blur-xl bg-card/60 border border-luxury-border rounded-2xl p-4 md:p-8 shadow-2xl">
            {loading ? (
              <div className="text-center py-8 md:py-12">
                <p className="text-muted-foreground text-base md:text-lg">Loading horror movies...</p>
              </div>
            ) : error ? (
              <div className="text-center py-8 md:py-12">
            ...
            {!loading && !error && filteredMovies.length === 0 && searchQuery && (
              <div className="text-center py-8 md:py-12">
                <p className="text-muted-foreground text-base md:text-lg">No horror movies found for "{searchQuery}"</p>
            ...
            {!loading && !error && movies.length === 0 && !searchQuery && (
              <div className="text-center py-8 md:py-12">
                <p className="text-muted-foreground text-base md:text-lg">No horror movies available</p>
      ...
      <section className="relative z-10 px-4 md:px-6 pb-12">
        <div className="max-w-7xl mx-auto text-center">
          <div className="backdrop-blur-xl bg-card/40 border border-luxury-border rounded-2xl p-6 shadow-xl">
            ...
            <p className="text-muted-foreground mb-6">Join our Telegram group for instant notifications on new horror movies</p>
            <TelegramJoin 
              variant="default" 
